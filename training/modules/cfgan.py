...
class Coarse2fine_generator(nn.Module):
    ...
    """"
     input_nc, output_nc, ngf=64, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d,
                 ...
                 add_out_act=True, max_features=1024, out_ffc=False, out_ffc_kwargs={}
    """
    def __init__(self, input_nc=4, output_nc=3, ngf=32, n_downsampling=3, n_blocks=9, norm_layer=nn.BatchNorm2d,
                 padding_type='reflect',activation_layer=nn.ReLU,up_norm_layer=nn.BatchNorm2d, up_activation=nn.ReLU(True),
                 init_conv_kwargs={}, downsample_conv_kwargs={}, resnet_conv_kwargs={},
                 spatial_transform_layers=None, spatial_transform_kwargs={},
                 add_out_act=True, max_features=1024, out_ffc=False, out_ffc_kwargs={},n_local_enhancers=1, n_blocks_local=3):
        super(Coarse2fine_generator, self).__init__()
        self.n_local_enhancers = n_local_enhancers

        ###### global generator model #####
        ngf_global = ngf * (2 ** n_local_enhancers)

        model_global=FFCResNetGenerator(input_nc,output_nc,ngf=ngf_global,n_downsampling=n_downsampling,
                                        n_blocks=n_blocks,add_out_act=add_out_act,init_conv_kwargs=init_conv_kwargs,
                                                        downsample_conv_kwargs=downsample_conv_kwargs,
                                                        resnet_conv_kwargs=resnet_conv_kwargs,activation_layer=activation_layer).model
    ...
    def forward(self, input):
        ...
        ### build up one layer affct a time
